...
with open("assets/currency_tree.pkl", "rb") as f:
    tbic_port = pickle.load(f)

fig = px.treemap(tbic_port, path=['portfolio', 'currency', 'gics_sector', 'gics_industry', 'name'],
                     values='value', color='30d Chg %', color_continuous_scale='thermal',
                     height=700)
